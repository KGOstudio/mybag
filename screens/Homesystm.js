        ...
        <ImageBackground source={require('../images/backHomescreen.jpg')} style={{width:screenWidht, height: screenHeight}}>
            ...
            <ScrollView style={{marginTop: 30}}>
                ...
                <ScrollView horizontal={true} >
                    <TouchableOpacity onPress={() => {props.navigation.navigate('occSystem');}}>
...
{/* system for teacher */}
                <ScrollView horizontal={true} >
                    <TouchableOpacity onPress={() => {setAniOpn(true); setTimeout(() => {setAniOpn(false);props.navigation.navigate('HomeWork')},2700); }}>
                        <View style={{padding: 7,marginLeft: 50,marginTop: 30,backgroundColor: color.white, width: screenWidht * 0.3,alignItems:'center', borderRadius: 9, height: screenHeight * 0.23}}>
                    ...
                    <TouchableOpacity onPress={() => {props.navigation.navigate('examSystem'); }}>
                       <View style={{padding: 7,marginLeft: 50,marginTop: 30,backgroundColor: color.white, width: screenWidht * 0.3,alignItems:'center', borderRadius: 9,height: screenHeight * 0.23}}>
            ...
            {aniOpen &&
                <View style={{position: 'absolute', width:screenWidht ,height:screenHeight, padding: 7, backgroundColor: color.white}}>
                    <LottieView 
                        source={require('../assets/animation_lmth263l.json')}
                        autoPlay
                        loop
                        style={{width: screenWidht, height: screenHeight * 0.7, right: 9,marginTop: 70}}
                    />
                </View>
            }
