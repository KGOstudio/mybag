...
function homeWorkStudent (props) {
    ...
    const [countCo,setCoutCo] = useState(0);
    ...
    const _getHomeWork = (query) => {
        (async () => {
            ...
            try{
                ...
                const gethomework = await axios.get('/getHomeworkStudent', {
    ...
    return (
        <ImageBackground source={require('../../images/backHomescreen.jpg')} style={{width: screenWidht, height:screenHeight, padding: 7}} onLayout={async() => {
            ...
            onPress={async() => {setclass1(await AsyncStorage.getItem('class')); console.log(class1); _getHomeWork();}}>HomeWork</Text>
